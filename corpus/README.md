...
| `etcd` | Phase 3 | 强一致元数据存储与协调原语 |
| `minecraft` | Phase 3 | 共享模拟世界 / 客户端预测与权威服 |

各目录四文件齐全。Phase 1 复现校准见 `runs/2026-08-05-cal-*.md`；Phase 2 迁移校准见 `runs/2026-08-05-mig-sre-buddy.md`（PASS，非正式 GOLDEN）；Phase 3 etcd 复现校准见 `runs/2026-08-05-cal-etcd.md`（PASS）。版本矩阵见 [`COMPAT.md`](COMPAT.md)。
